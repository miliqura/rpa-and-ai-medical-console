...
export const nmpaScrapingSteps = [
  {
    label: "批准信息",
    title: "抓取药品批准信息",
    desc: "按品种列表批量查询批准文号、批准日期、有效期、生产企业等关键字段，自动导出结构化数据。",
    logs: [
      "进入药品查询模块",
      "加载品种列表，共200个品种",
      "批量查询批准文号中...",
  ...
  },
  {
    label: "器械注册",
    title: "抓取器械注册证信息",
    desc: "切换至医疗器械查询模块，批量抓取注册证号、注册人、产品名称、有效期等字段，重点标注临期和已过期证件。",
    logs: [
      "切换至医疗器械查询模块",
      "加载器械品种列表，共120个品种",
      "批量抓取注册证信息中...",
      "已完成 89 / 120 个品种",
      "识别临期证件 3 条，三类器械设置360天预警",
    ],
  },
  {
    label: "召回公告",
    title: "抓取药品召回公告",
    desc: "监控NMPA召回公告页面，自动识别新增公告，提取召回药品名称、批号、召回原因，比对本企业品种库，命中则立即预警。",
    logs: [
      "进入召回公告页面",
      "抓取近期公告，共5条",
      "比对本企业品种库...",
  ...
  },
  {
    label: "法规监测",
    title: "政策法规更新监测",
    desc: "抓取NMPA法规动态、通告、指导原则等页面，AI自动提取标题、发布日期、关键影响点，推送与本企业品种相关的法规变更。",
    logs: [
      "进入法规动态页面",
      "抓取近期法规更新，共5条",
      "AI关联分析：匹配企业品种库和在研项目",
...
export const nmpaApprovalRows = [
  {
    name: "阿莫西林胶囊",
    approval: "国药准字H10900001",
    date: "2020-03-15",
    expire: "2025-03-14",
    company: "华北制药集团",
  },
...
export const nmpaRegRows = [
  {
    date: "2025-06-06",
    title: "关于进一步加强药品追溯码管理的公告",
    type: "公告",
    impact: "高影响",
    keywords: "追溯码、扫码率、批发企业",
  },
  {
    date: "2025-06-05",
    title: "人用药品技术要求国际协调理事会Q3D(R1)指导原则",
    type: "指导原则",
    impact: "中影响",
    keywords: "元素杂质、PDE值、检测方法",
  },
  {
    date: "2025-06-04",
    title: "化学药品注册分类及申报资料要求",
    type: "通知",
    impact: "中影响",
    keywords: "注册分类、申报资料、CTD格式",
  },
  {
    date: "2025-06-03",
    title: "药物警戒质量管理规范（GVP）修订草案征意见",
    type: "征求意见",
    impact: "高影响",
    keywords: "GVP、药物警戒、ADR报告",
  },
  {
    date: "2025-06-01",
